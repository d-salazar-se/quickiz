...
class TakeAQuizResultComponent extends Component {
  constructor(props) {
    super(props);
              ...
              <div className="panelcrear">
                <div className="formcrear">
                  <Grid container direction="row" justify="center" alignItems="center" spacing={24}>
                    ...
                    <Grid item xs={6}>
                      <Typography variant="h5" gutterBottom>
                        Puntaje: { this.state.quiz.score + 1}
                      </Typography>
                    </Grid>
                  </Grid>
                                ...
                                <TableRow key={index}>
                                  <TableCell scope="questionInstance">
                                    ...
                                    <TextField
                                      ...
                                      fullWidth
                                      disabled={true}
                                      defaultValue={questionInstance.studentAnswer}
                                      placeholder=" "
                  ...
                  <Button component={Link} to="/my/quizzes/">
                    Volver
                  </Button>
                </div>
              </div>
...
export default withSnackbar(TakeAQuizResultComponent);
